...
import VarientsTableBody from "./_components/VarientsTableBody";
import ComponentCard from "@/components/common/ComponentCard";

export const metadata: Metadata = {
  title: "Varient List | Nanuvaier Rosona Kothon - Your Online Shop",
  description: "An online store for all your needs",
};
const headers: string[] = ["Image", "SKU", "Price", "Stock", "Actions"];
...
export default async function VarientsPage({
  searchParams,
}: {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Varient List" />
