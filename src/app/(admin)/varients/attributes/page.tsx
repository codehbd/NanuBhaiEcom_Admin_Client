...
import AttributesTableBody from "./_components/AttributesTableBody";
import CreateAttribute from "./_components/CreateAttribute";

export const metadata: Metadata = {
  title: "Varient-Attributes | Nanuvaier Rosona Kothon - Your Online Shop",
  description: "An online store for all your needs",
};
const headers: string[] = ["Name", "Value", "Actions"];
...
export default async function AttributesPage() {
  return (
    <>
      <PageBreadcrumb pageTitle="Varient Attributes" />
      <CreateAttribute />
